...
s='
echo "Test onlymask"
#python prediction.py --data_path $data_path --channels rgb b8 b8a b11 b12 ndvi ndmi --model_weights_path ../logs/$name/checkpoints/best.pth --test_df $data_path/onlymasksplit/test_df.csv --save_path ../data/predictions/$name --network $network --size $image_size
...
echo "Train onlymask"
#python prediction.py --data_path $data_path --channels rgb b8 b8a b11 b12 ndvi ndmi --model_weights_path ../logs/$name/checkpoints/best.pth --test_df $data_path/onlymasksplit/train_df.csv --save_path ../data/predictions/$name --network $network --size $image_size
...
echo "Valid onlymask"
#python prediction.py --data_path $data_path --channels rgb b8 b8a b11 b12 ndvi ndmi --model_weights_path ../logs/$name/checkpoints/best.pth --test_df $data_path/onlymasksplit/valid_df.csv --save_path ../data/predictions/$name --network $network --size $image_size
...
'
echo "Test"
#python prediction.py --data_path $data_path --channels rgb b8 b8a b11 b12 ndvi ndmi --model_weights_path ../logs/$name/checkpoints/best.pth --test_df $data_path/test_df.csv --save_path ../data/predictions/$name --network $network --size $image_size
...
echo "Train"
#python prediction.py --data_path $data_path --channels rgb b8 b8a b11 b12 ndvi ndmi --model_weights_path ../logs/$name/checkpoints/best.pth --test_df $data_path/train_df.csv --save_path ../data/predictions/$name --network $network --size $image_size
...
echo "Valid"
#python prediction.py --data_path $data_path --channels rgb b8 b8a b11 b12 ndvi ndmi --model_weights_path ../logs/$name/checkpoints/best.pth --test_df $data_path/valid_df.csv --save_path ../data/predictions/$name --network $network --size $image_size
